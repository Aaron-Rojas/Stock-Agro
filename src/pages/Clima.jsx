...
const TEXTO_LECTURA = `Clima soleado y despejado. Lima, Perú, fecha actual: ${FECHA_ACTUAL}. ¡Hoy es un gran día para trabajar en el campo!. Presiona la tecla 0 para regresar al inicio.`;
